...
var ActionModal = /*#__PURE__*/function (_Component) {
  ...
  function ActionModal(props) {
    ...
    _this.renderInternalButton = function () {
      ...
      return btnNode ? /*#__PURE__*/React.createElement(_Button, {
        type: "primary",
  ...
  _createClass(ActionModal, [{
    ...
    value: function render() {
      ...
      }, btn) : this.renderInternalButton(), /*#__PURE__*/React.createElement(_Modal, _objectSpread(_objectSpread(_objectSpread({
        visible: visible
